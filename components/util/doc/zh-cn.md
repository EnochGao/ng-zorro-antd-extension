...
| scrollToFirstInvalidControl | 页面滚动到第一个校验失败的表单控件，一般与 updateControlStatus 一起使用  | <label type="success">v17.4+</label>   |
| getElementByTag             | 获取当前 document 下所有指定标签                                         | <label type="success">v17.4+</label>   |
